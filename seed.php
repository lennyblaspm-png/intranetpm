...
/**
 * Script de seed — Importe les 36 comptes dans MySQL
 * À exécuter une seule fois sur InfinityFree après configuration de config.mysql.php
 * URL : https://ton-site.infinityfreeapp.com/seed.php
 */
...
try {
    ...
    echo "<p style='color:red'>✗ Erreur connexion: " . htmlspecialchars($e->getMessage()) . "</p>";
    echo "<p>Vérifie config.mysql.php avec tes identifiants InfinityFree.</p>";
    exit;
}
...
echo "<p style='color:green'>✓ Table 'store' créée/vérifiée</p>";
...
$accounts = [
    ...
    ['rio'=>'6320157','password'=>'pyB4jNHdgv','nom'=>'PELIER','prenom'=>'Fred','grade'=>'STG','role'=>'Effectif','specialites'=>[],'webhookUrl'=>''],
    ['rio'=>'3021545','password'=>'znvh&d2B8p','nom'=>'ROLLAND','prenom'=>'Tobbias','grade'=>'STG','role'=>'Effectif','specialites'=>[],'webhookUrl'=>''],
    ...
    ['rio'=>'6575426','password'=>'&Z3WsHNTVe','nom'=>'HENDER','prenom'=>'Theo','grade'=>'GRT','role'=>'Effectif','specialites'=>[],'webhookUrl'=>''],
    ['rio'=>'7321524','password'=>'BP%rwZb4Ad','nom'=>'SUPERSTAR','prenom'=>'John','grade'=>'GRP','role'=>'Effectif','specialites'=>[],'webhookUrl'=>''],
    ['rio'=>'4789750','password'=>'@ms37&dP7B','nom'=>'FOLLET','prenom'=>'Elyon','grade'=>'GRP','role'=>'Effectif','specialites'=>[],'webhookUrl'=>''],
    ...
    ['rio'=>'1256789','password'=>'235URbkk&f','nom'=>'DASILVA','prenom'=>'Hugo','grade'=>'GRP','role'=>'Effectif','specialites'=>[],'webhookUrl'=>''],
    ...
    ['rio'=>'5908051','password'=>'#YMgfXRBaV','nom'=>'LEPOINTE','prenom'=>'Noah','grade'=>'BCH','role'=>'Effectif','specialites'=>[],'webhookUrl'=>''],
    ['rio'=>'6385123','password'=>'d%4sKYNJUW','nom'=>'MONTANA','prenom'=>'Romain','grade'=>'BCP','role'=>'Effectif','specialites'=>[],'webhookUrl'=>''],
    ...
    ['rio'=>'9412325','password'=>'VL@j*tvw6E','nom'=>'LOPEZ','prenom'=>'Noah','grade'=>'CDS-S','role'=>'Direction','specialites'=>[],'webhookUrl'=>''],
    ['rio'=>'9654123','password'=>'Qr&C*v4dkz','nom'=>'WILLIAMS','prenom'=>'Lucas','grade'=>'CDS-S','role'=>'Direction','specialites'=>[],'webhookUrl'=>''],
    ...
    ['rio'=>'3265879','password'=>'uwQHVyWct$','nom'=>'LAGARDE','prenom'=>'Fabien','grade'=>'CDS-1','role'=>'Direction','specialites'=>[],'webhookUrl'=>''],
    ['rio'=>'5123658','password'=>'n%srjtgHs8','nom'=>'SCOTT','prenom'=>'Erwann','grade'=>'DRA','role'=>'Direction','specialites'=>[],'webhookUrl'=>''],
];
...
echo "<p style='color:green'>✓ <strong>$count comptes importés dans MySQL</strong></p>";

// Vérification
$rows = $pdo->query("SELECT `key`, LENGTH(`value`) as len FROM `store`")->fetchAll();
echo "<h3>Contenu de la table 'store' :</h3>";
echo "<table border='1' cellpadding='5'>";
echo "<tr><th>Key</th><th>Taille</th></tr>";
foreach ($rows as $row) {
    echo "<tr><td>" . htmlspecialchars($row['key']) . "</td><td>" . $row['len'] . " octets</td></tr>";
}
echo "</table>";
echo "<p><strong>Terminé !</strong> Tu peux supprimer seed.php après.</p>";
