    ...
    <div class="pub-wrapper">
        ...
        <div class="bottom-grid">
            ...
            <div class="panel">
                ...
                <a class="link-item" href="https://www.tiktok.com/@lenky.officiel" target="_blank" style="background:#000; color:#fff; border:1px solid #000; margin-top:6px;"><div class="link-icon" style="background:#000; color:#fff;"><i class="fab fa-tiktok"></i></div><span class="link-label" style="color:#fff;">TikTok @lenky.officiel</span><i class="fas fa-arrow-right link-arrow" style="color:#fff;"></i></a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="pub-wrapper" style="max-width:800px;">
        ...
        <div style="background:#fff; border:1px solid #e2e8f0; border-radius:10px; padding:24px;">
            ...
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:12px;">
                ...
                <a href="https://www.tiktok.com/@lenky.officiel" target="_blank" style="display:flex; align-items:center; gap:12px; padding:14px; background:#000; border:1px solid #000; border-radius:10px; color:#fff;"><div style="width:36px; height:36px; background:#fff; color:#000; border-radius:8px; display:flex; align-items:center; justify-content:center;"><i class="fab fa-tiktok"></i></div><div><div style="font-weight:700; font-size:13px;">TikTok</div><div style="font-size:11px; color:#a1a1aa;">@lenky.officiel</div></div><i class="fas fa-arrow-right" style="margin-left:auto; color:#fff;"></i></a>
            </div>
